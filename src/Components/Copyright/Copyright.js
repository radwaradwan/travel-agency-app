...
function Copyright() {
    return (
        <section>
            <div className={`d-flex justify-content-center flex-md-row flex-column p-3 ${styles.CopyrightSection}`}>
                <div className='col-md-auto d-flex justify-content-center me-md-4'>
